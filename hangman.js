...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let randomizedWord = '';
    let maskedWord = '';
    const words = ["apple", "banana", "orange", "grape", "pineapple", "watermelon", "strawberry"];
    ...
    function newGame() {
        ...
        // Update the "Try to guess this word" span with the randomized word
        document.getElementById('try-to-guess').textContent = randomizedWord;
    }
